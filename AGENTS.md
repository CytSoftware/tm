...
uv run python manage.py mcp_serve             # MCP over stdio (for Codex Desktop). Remote MCP is auto-served at /mcp/ by daphne.
...
- **stdio**: `python manage.py mcp_serve` — for Codex Desktop.
