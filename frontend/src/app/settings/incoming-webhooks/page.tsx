      ...
      <header className="shrink-0 h-14 px-4 border-b border-border/80 flex items-center gap-3">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-muted-foreground">
            Receive external events and present each source as a monitoring
            page.
          </p>
        </div>
              ...
              <div className="max-w-sm space-y-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[12px] text-muted-foreground">
                    Each incoming webhook source gets its own page, icon, and
                    columns.
                  </p>
                </div>
                <Button size="sm" onClick={() => setCreateOpen(true)}>
      ...
      <DialogContent className="max-w-[460px] p-0 gap-0" showCloseButton={false}>
        <div className="px-5 py-4 border-b border-border/60">
          ...
          <p className="mt-1 text-[11px] text-muted-foreground">
            This creates both an incoming webhook URL and its sidebar page.
          </p>
        </div>
