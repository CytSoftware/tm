        ...
        <header className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[12px] text-muted-foreground">
              External endpoints that receive your task events as signed HTTP
              POSTs — for agents and integrations.
            </p>
          </div>
        ...
        <section className="rounded-lg border border-border bg-card">
          {endpoints.length === 0 && (
            <p className="px-4 py-6 text-[12px] text-muted-foreground text-center">
              No webhooks yet. Add one to push task events to an external
              endpoint.
            </p>
          )}
